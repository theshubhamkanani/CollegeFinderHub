          ...
          <div class="card-body">
            ...
            <form action="addCollege" method="POST">
              <div class="form-group">
                ...
                <input type="text" placeholder="Enter College name" name="CollegeName" required class="form-control" />
              </div>
              <div class="form-group">
                <label>College Official Website</label>
                <input type="text" placeholder="Enter College Official Website" name="CollegeWebsite" required class="form-control" />
              </div>
              <div class="form-row">
              ...
              <div class="form-group">
                ...
                <textarea required rows="6" placeholder="Enter College Address" cols="" name="Address" class="form-control"></textarea>
              </div>
              <button class="btn btn-primary">Publish College</button>
